...
interface ComboboxProps {
  options: { label: string; value: string; id: string }[]; // Add id to options
  value?: string;
...
export const Combobox = ({
  ...
  const [filtered, setFiltered] = React.useState<{ label: string; value: string; id: string }[]>([]);
